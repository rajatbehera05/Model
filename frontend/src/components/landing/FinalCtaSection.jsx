    ...
    <section className="py-10 lg:py-14 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative rounded-3xl bg-gradient-to-b from-blue-50/70 via-indigo-50/40 to-white border border-blue-200/60 p-8 sm:p-12 text-center shadow-xl shadow-blue-500/5 overflow-hidden"
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm tracking-tight shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/35 hover:-translate-y-0.5 transition-all cursor-pointer group"
              >
